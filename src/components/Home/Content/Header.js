        ...
        <header className='header'>
            <div className='header__left'>
                <div className='header__phone'>
                    ...
                    <a className='header__phone-tel' href="">+996 705 188 955</a>
                    <a className='header__phone-tel' href="">+996 555 188 955</a>
            ...
            <div className='header__right'>
                ...
                <div className='header__search'>
                    <input type="search" style={{display: `${search ? 'inline-block': 'none'}`}} className='header__search-input' onChange={(e)=> searchHandler(e.target.value)}/>
